          ...
          {isDevMode && (
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Development Mode:</strong> Use any email/password to sign in
              </p>
            </div>
          )}
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder={isDevMode ? "Any email (e.g., test@example.com)" : "Enter your email"}
              ...
              <div className="relative">
                <input
                  ...
                  {...register('password', {
                    ...
                    minLength: {
                      value: isDevMode ? 1 : 6,
                      message: isDevMode ? 'Password is required' : 'Password must be at least 6 characters'
                    }
                  })}
                  onChange={handleInputChange}
                  ...
                  placeholder={isDevMode ? "Any password" : "Enter your password"}
                  disabled={isSubmitting}
                />
                <button
                  type="button"
