          ...
          {isDevMode && (
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Development Mode:</strong> Use any email/password to create an account
              </p>
            </div>
          )}
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder={isDevMode ? "Any password" : "Create password"}
                    disabled={isSubmitting}
                  />
                  <button
                    type="button"
                ...
                {!isDevMode && watchedPassword && passwordValidation && (
